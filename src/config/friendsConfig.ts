...
export const friendsConfig: FriendLink[] = [
  ...
  { title: 'Astro', imgurl: 'https://avatars.githubusercontent.com/u/44914786?v=4&amp;amp;amp;amp;amp;amp;s=640', desc: 'The web framework for content-driven websites. ⭐️ Star to support our work!', siteurl: 'https://github.com/withastro/astro', tags: ['Framework'], weight: 8, enabled: true }
];
